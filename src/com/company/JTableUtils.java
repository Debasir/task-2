...
public class JTableUtils {
    ...
    public static int[][] readIntMatrixFromJTable(JTable table) throws ParseException {
        try {
            ...
            return (int[][]) Arrays.stream(matrix).map(lib.ArrayUtils::toPrimitive).toArray((n) -> new int[n][]);
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
    ...
    public static double[][] readDoubleMatrixFromJTable(JTable table) throws ParseException {
        try {
            ...
            return (double[][]) Arrays.stream(matrix).map(lib.ArrayUtils::toPrimitive).toArray((n) -> new double[n][]);
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
    ...
    public static double[] readDoubleArrayFromJTable(JTable table) throws ParseException {
        try {
            return lib.ArrayUtils.toPrimitive(readArrayFromJTable(table, Double.class, JTableUtils::parseDouble, false, 0.0));
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
